...
# ResNet50 için optimize edilmiş veri dönüşümleri
...
train_loader = DataLoader(train_dataset, batch_size=32, shuffle=True)  # ResNet için daha büyük batch size
...
for epoch in range(num_epochs):
    try:
        ...
        model_save_path = os.path.join(SAVE_DIR, f'resnet50_epoch_{epoch+1}_acc_{val_acc:.4f}.pth')
        ...
        if val_acc > best_val_acc:
            ...
            best_model_path = os.path.join(SAVE_DIR, f'resnet50_best_acc_{val_acc:.4f}.pth')
        ...
        print("\nEğitim durduruldu!")
        interrupted_model_path = os.path.join(SAVE_DIR, f'resnet50_interrupted_epoch_{epoch+1}_acc_{val_acc:.4f}.pth')
